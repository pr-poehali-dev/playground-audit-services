...
const services = [
  ...
  },
  {
    icon: "Award",
    title: "Сертификация",
    description: "Выдача сертификата соответствия после успешной проверки площадки",
    color: "hsl(var(--accent))",
    bg: "hsl(168 76% 42% / 0.1)",
    emoji: "🏆",
  },
  {
    icon: "RefreshCw",
    title: "Ежегодный аудит",
    description: "Регулярные проверки для поддержания безопасности на протяжении всего года",
    color: "hsl(var(--pink))",
    bg: "hsl(330 81% 60% / 0.1)",
    emoji: "🔄",
  },
  {
    icon: "Wrench",
